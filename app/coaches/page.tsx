			...
			<section className="page-heading bg-image">
				<div className="pt-[200px] pb-[75px] page-width">
					<div className="page-heading-wrapper uppercase">
						<h1 className="text-white inner-page-headings">Online Coaching</h1>
					</div>
				</div>
			</section>
			<section className="flex flex-col gap-[40px] bg-black py-[100px]">
				<div className="flex flex-col gap-[40px] page-width animate__animated animate__fadeInUp duration-1000">
					<div className="flex flex-col items-center gap-[20px]">
						...
						<p className="text-zinc-500 description text-center">
							Meet professional fitness coaches who are dedicated to helping you achieve your fitness goals through personalized workouts and expert
							guidance.
						</p>
					</div>
...
function CoachCard({ imageSrc, name, nickname, title, contact, email, facebook, instagram, tiktok, website, otherLinks }: CoachCardProps) {
	return (
