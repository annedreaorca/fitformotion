...
import { IconCalendarStats, IconClock, IconTrendingUp } from "@tabler/icons-react";
import { format, subDays } from "date-fns";
import { Suspense } from "react";

// Dummy data to replace Prisma and Clerk
const dummyUserInfo = {
...
const dummyWeightLogs = [
  {
    weight: 82.5,
    recordedAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 14) // 2 weeks ago
  }
];

function BeginnerWeeklyProgress() {
    // Use dummy data instead of fetching from database
    const userInfo = dummyUserInfo;
    const workouts = dummyWorkouts;
    const weightLogs = dummyWeightLogs;
